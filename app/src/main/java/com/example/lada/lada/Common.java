...
public class Common {
    ...
    public static final String REQUEST_DRIVER_TITLE = "Request Driver";
    ...
    public static final String RIDER_INFO = "Users";
    public static final String REQUEST_DRIVER_ACCEPT = "Accept";
    public static final String TRIP_KEY = "TripKey";
    public static final String TRIP_PICKUP_REF = "TripPickupLoccation";
    ...
    public static void showNotification(Context context, int id, String title, String body, Intent intent) {
        ...
        String NOTIFICATION_CHANNEL_ID ="lada";
        NotificationManager notificationManager = (NotificationManager)context.getSystemService(Context.NOTIFICATION_SERVICE);

        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O){
            NotificationChannel notificationChannel = new NotificationChannel(NOTIFICATION_CHANNEL_ID, "Lada", NotificationManager.IMPORTANCE_HIGH);
            notificationChannel.setDescription("Lada Taxi");
